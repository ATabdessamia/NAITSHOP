...
const DialogBox = ({ onClick, cancle }) => {
  return (
    <div className="bg-green-700 w-4/6 sm:w-2/5 md:w-1/4 transform absolute left-1/2 top-1/4 -translate-x-1/2 p-5 flex flex-col text-gray-100 z-50 shadow-xl rounded">
